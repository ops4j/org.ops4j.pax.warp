CREATE TABLE numbers (   id int NOT NULL,   i8 smallint NOT NULL,   i16 smallint NOT NULL,   i32 int NOT NULL,   i64 bigint NOT NULL,   d decimal NOT NULL ) 
CREATE TABLE strings (   id varchar(255) NOT NULL,   c4 char(4) NOT NULL,   c254 char(254) NOT NULL,   v4 varchar(4) NOT NULL,   v255 varchar(255) NOT NULL,   t clob NOT NULL,   enabled boolean NOT NULL ) 
